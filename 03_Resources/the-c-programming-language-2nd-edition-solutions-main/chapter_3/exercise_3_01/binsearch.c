...
// NOTE: By using a simple test in the for loop there is a chance to increase
// the binsearch() execution speed. Just modifying an if-else statement from 3
// branches with two condition testing to 2 branches with 1 condition testing
// will not increase drasticaly the program performance on modern machines, but
// is a better aproach.
